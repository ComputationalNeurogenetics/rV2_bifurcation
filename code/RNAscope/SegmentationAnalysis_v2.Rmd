...
p1 <- plot_sliding_mean_replicates(combined_replicates, window_size = 12, use_cell_normalized = FALSE, normalize_per_channel=TRUE, align_channels_across_replicates = TRUE)
...
p1 <- plot_sliding_mean_replicates(combined_replicates, window_size = 12, use_cell_normalized = FALSE, normalize_per_channel=TRUE, align_channels_across_replicates = TRUE, exclude_channels=2)
...
```{r}
save_image(file="SegmentationAnalysisImage121124.RData")
```
