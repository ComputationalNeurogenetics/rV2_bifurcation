...
count.per.cell.channel.filt.sb514 <- count.per.cell.channel.filt
```
...
count.per.cell.channel.filt <- process_and_filter_cell_data(rois.ss, rois, three.points, count.per.cell.channel, quantile_threshold = 0.25)
count.per.cell.channel.filt.sb509 <- count.per.cell.channel.filt
```
...
count.per.cell.channel.filt <- process_and_filter_cell_data(rois.ss, rois, three.points, count.per.cell.channel, quantile_threshold = 0.25)
count.per.cell.channel.filt.sb510 <- count.per.cell.channel.filt
```
