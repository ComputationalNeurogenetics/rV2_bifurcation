...
colnames(assay.averages$RNA) <- str_replace_all(string = colnames(assay.averages$RNA), pattern = "-", replacement = "_")
...
## With C&T but no conservation included in conditions
...
# GO enrichments 25-25-25 among target genes (C&T overlap and conservartion incl.) {.tabset}
