...
test.tal1 <- extract.factors(db.name = "~/Workspace/TOBIAS.dr.h12_2.sqlite", group_name = "CO1_2", gene_name = "Tal1", zscore.thr=0)

test.gata2 <- extract.factors(db.name = "~/Workspace/TOBIAS.dr.h12_2.sqlite", group_name = "CO1_2", gene_name = "Gata2", zscore.thr=0)

test.gata3 <- extract.factors(db.name = "~/Workspace/TOBIAS.dr.h12_2.sqlite", group_name = "CO1_2", gene_name = "Gata3", zscore.thr=0)
