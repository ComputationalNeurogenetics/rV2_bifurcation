...
test.2 <- dbGetQuery(con.obj, 'SELECT * FROM tobias as tb,feature as ft, exp as exp WHERE ft.seqnames="chr4" AND ft.start>=114986077 AND ft.end<=115134633 AND tb.features==ft.feature AND mean_cons>0.5 AND exp')
```
