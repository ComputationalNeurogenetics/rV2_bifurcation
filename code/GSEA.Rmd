...
geneSets <- list(targets.Tal1=targets.Tal1$ensg_id, targets.Gata2=targets.Gata2$ensg_id, targets.Gata3=targets.Gata3$ensg_id,targets.Sox4=targets.Sox4$ensg_id, targets.Vsx2=targets.Vsx2$ensg_id)

results <- fgsea(pathways = geneSets, 
                 stats = DEG.res.final, 
                 minSize = 15,  # Minimum size of a gene set to be considered
