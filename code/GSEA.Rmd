...
genes_with_go <- getBM(attributes = c('ensembl_gene_id', 'go_id'),
...
geneID2GO <- split(genes_with_go$go_id, genes_with_go$ensembl_gene_id)

# Optionally, you can remove genes with no GO IDs if any exist
geneID2GO <- geneID2GO[sapply(geneID2GO, length) > 0]

# Print the structure of the first few list elements to check
print(str(geneID2GO[1:5]))
```
