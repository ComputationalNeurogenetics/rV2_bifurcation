...
DefaultAssay(rV2.data) <- "peaks"
ct.tr <- PeakPlot(rV2.data, peaks = Tal1.ct, region=f2.range, color="darkred")
ct.tr$labels$y <- "C&T Tal1"
```
...
combined.p <- CombineTracks(
  plotlist = list(coverage_track, gene_track, link_track,peak_track,cons.tr,ct.tr),
  expression.plot = expression_plot_data,
  heights = c(.75,0.05,0.05,0.05,0.05,0.05),
  widths = c(10,5)
