...
monsterRes <- monster(expr=exp.lineage, design=design.bin, motif=as.data.frame(TF.gene.data.sum), nullPerms=100, numMaxCores=12, alphaw=1, outputDir = "../analysis/Monster/")
saveRDS(monsterRes, file="../analysis/Monster.Rds")
```
...
monsterTransitionNetworkPlot(monsterRes, numEdges=100,numTopTFs = 100)
```
