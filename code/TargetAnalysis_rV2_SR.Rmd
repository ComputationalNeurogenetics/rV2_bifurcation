...
Idents(merged.datasets) <- merged.datasets$merged.groups
DEG.res.3 <- FindMarkers(merged.datasets, ident.1="SR2", ident.2 = "SR3",logfc.threshold=0, assay = "RNA", slot="data", mean.fxn=mean.fxn, min.pct = 0) %>% rownames_to_column(var="ensg_id") %>% as_tibble()
