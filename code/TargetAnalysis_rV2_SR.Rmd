...
CO_GA.subset <- subset(rV2.dataset, idents=c("CO1_2","GA1_2"))
CO_GL.subset <- subset(rV2.dataset, idents=c("CO1_2","GL1_2"))
...
SR2_3.subset <- subset(serot.dataset, idents=c("SR2","SR3"))
...
# SR2.correlations 
expression_matrix <- GetAssayData(SR2_3.subset, slot = "data", assay = "RNA")
