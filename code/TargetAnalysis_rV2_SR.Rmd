...
data2plot <- log1p(assay.averages.rV2$RNA[pos.targets$ensg_id,c("PRO1","PRO2","CO1","CO2","GA1","GA2","GA3","GA4","GA5","GA6","GL1","GL2","GL3","GL4","GL5")])
...
Heatmap(
  data2plot,
  name = "RNA expression",
  row_split = pos.targets$bin_category,  # Split rows by bin_category
