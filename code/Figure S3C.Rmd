...
```{r}
plot_loc <- "~/OneDrive - University of Helsinki/E12R1 project/Manuscript I - Regulation of Tal1 dependent rV2 lineage bifurcation/Figures/plots/FigS3/"
plot_name <- paste("FigureS3_",gene.of.interest,".pdf",sep="")
