...
Tal1_RE <-fetch.regulators_v2(db.name=paste(db.path,dbname.rV2,sep=""), "Tal1", "GA1_2")
Tal1_RE <-unique(Tal1_RE[1])

Gata2_RE <-fetch.regulators_v2(db.name=paste(db.path,dbname.rV2,sep=""), "Gata2", "GA1_2")
Gata2_RE <-unique(Gata2_RE[1])

Gata3_RE <-fetch.regulators_v2(db.name=paste(db.path,dbname.rV2,sep=""), "Gata3", "GA1_2")
Gata3_RE <-unique(Gata3_RE[1])
```
...
Tal1_RE <-fetch.regulators_v2(db.name=paste(db.path,dbname.rV2,sep=""), "Tal1", "CO1_2")
Tal1_RE <-unique(Tal1_RE[1])

Gata2_RE <-fetch.regulators_v2(db.name=paste(db.path,dbname.rV2,sep=""), "Gata2", "CO1_2")
Gata2_RE <-unique(Gata2_RE[1])

Gata3_RE <-fetch.regulators_v2(db.name=paste(db.path,dbname.rV2,sep=""), "Gata3", "CO1_2")
Gata3_RE <-unique(Gata3_RE[1])
```
...
Vsx1_RE <-fetch.regulators_v2(db.name=paste(db.path,dbname.rV2,sep=""), "Vsx1", "GL1_2")
Vsx1_RE <-unique(Vsx1_RE[1])

Vsx2_RE <-fetch.regulators_v2(db.name=paste(db.path,dbname.rV2,sep=""), "Vsx2", "GL1_2")
...
Vsx1_RE <-fetch.regulators_v2(db.name=paste(db.path,dbname.rV2,sep=""), "Vsx1", "CO1_2")
Vsx1_RE <-unique(Vsx1_RE[1])

Vsx2_RE <-fetch.regulators_v2(db.name=paste(db.path,dbname.rV2,sep=""), "Vsx2", "CO1_2")
Vsx2_RE <-unique(Vsx2_RE[1])
```
