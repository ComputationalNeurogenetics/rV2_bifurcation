...
for (i in 1:nrow(Tal1.features)){
  p1 <- plotHorizDotplot_v2(feature.coords = as.character(Tal1.features[i,2]))
  if(is.list(p1)){
  pdf(file=paste(plot_loc_tal1,paste("Tal1f",i,"_dotplot.pdf",sep=""),sep=""), width = 12, height = 8)
  print(p1)
  dev.off()
  }
}
...
for (i in 1:nrow(Vsx2.features)){
  p1 <- plotHorizDotplot_v2(feature.coords = as.character(Vsx2.features[i,2]))
  if(is.list(p1)){
  pdf(file=paste(plot_loc_vsx2,paste("Vsx2f",i,"_dotplot.pdf",sep=""),sep=""), width = 12, height = 8)
  print(p1)
  dev.off()
  }
}
...
for (i in 1:nrow(Gata2.features)){
  p1 <- plotHorizDotplot_v2(feature.coords = as.character(Gata2.features[i,2]))
  if(is.list(p1)){
  pdf(file=paste(plot_loc_gata2,paste("Gata2f",i,"_dotplot.pdf",sep=""),sep=""), width = 12, height = 8)
  print(p1)
  dev.off()
  }
}
...
for (i in 1:nrow(Gata3.features)){
  p1 <- plotHorizDotplot_v2(feature.coords = as.character(Gata3.features[i,2]))
  if(is.list(p1)){
  pdf(file=paste(plot_loc_gata3,paste("Gata3f",i,"_dotplot.pdf",sep=""),sep=""), width = 12, height = 8)
  print(p1)
  dev.off()
  }
}
