...
Tal1.f6 <- plotFootprintDotplot.rV2.comp(tobias.fp.gr = rV2.groups.tobias.h12.gr.dr, gr.filter = tal1.feat6, TF.motifs = TF.motifs.out, dataset=dataset, parallel=TRUE)

pdf(file=paste(plot_loc,"Tal1_f6_comp_dotplot.pdf",sep=""), width = 8, height = 16)
Tal1.f6
dev.off()

Tal1.f11 <- plotFootprintDotplot.rV2.comp(tobias.fp.gr = rV2.groups.tobias.h12.gr.dr, gr.filter = tal1.feat11, TF.motifs = TF.motifs.out, dataset=dataset, parallel=T)

pdf(file=paste(plot_loc,"Tal1_f11_comp_dotplot.pdf",sep=""), width = 8, height = 16)
Tal1.f11
dev.off()

Tal1.f14 <- plotFootprintDotplot.rV2.comp(tobias.fp.gr = rV2.groups.tobias.h12.gr.dr, gr.filter = tal1.feat14, TF.motifs = TF.motifs.out, dataset=dataset, parallel = T)
...
Tal1.f6 <- plotFootprintDotplot.rV2.noncomp(tobias.fp.gr = rV2.groups.tobias.h12.gr.dr, gr.filter = tal1.feat6, TF.motifs = TF.motifs.out, dataset=dataset, parallel=TRUE)

pdf(file=paste(plot_loc,"Tal1_f6_non_comp_dotplot.pdf",sep=""), width = 8, height = 20)
Tal1.f6
dev.off()

Tal1.f11 <- plotFootprintDotplot.rV2.noncomp(tobias.fp.gr = rV2.groups.tobias.h12.gr.dr, gr.filter = tal1.feat11, TF.motifs = TF.motifs.out, dataset=dataset, parallel=T)

pdf(file=paste(plot_loc,"Tal1_f11_non_comp_dotplot.pdf",sep=""), width = 8, height = 20)
Tal1.f11
dev.off()

Tal1.f14 <- plotFootprintDotplot.rV2.noncomp(tobias.fp.gr = rV2.groups.tobias.h12.gr.dr, gr.filter = tal1.feat14, TF.motifs = TF.motifs.out, dataset=dataset, parallel = T)
...
Vsx2.feat5.p1 <- plotFootprintDotplot.rV2.noncomp(tobias.fp.gr = rV2.groups.tobias.h12.gr.dr, gr.filter = vsx2.feat5, TF.motifs = TF.motifs.out, dataset=dataset, parallel=TRUE)

pdf(file=paste(plot_loc,"Vsx2_f5_non_comp_dotplot.pdf",sep=""), width = 8, height = 20)
Vsx2.feat5.p1
dev.off()

Vsx2.feat12.p1 <- plotFootprintDotplot.rV2.noncomp(tobias.fp.gr = rV2.groups.tobias.h12.gr.dr, gr.filter = vsx2.feat12, TF.motifs = TF.motifs.out, dataset=dataset, parallel=T)

pdf(file=paste(plot_loc,"Vsx2_feat12_non_comp_dotplot.pdf",sep=""), width = 8, height = 20)
Vsx2.feat12.p1
dev.off()

Vsx2.feat15.p1 <- plotFootprintDotplot.rV2.noncomp(tobias.fp.gr = rV2.groups.tobias.h12.gr.dr, gr.filter = vsx2.feat15, TF.motifs = TF.motifs.out, dataset=dataset, parallel = T)

pdf(file=paste(plot_loc,"Vsx2_feat15_non_comp_dotplot.pdf",sep=""), width = 8, height = 20)
Vsx2.feat15.p1
dev.off()

Vsx2.feat17.p1 <- plotFootprintDotplot.rV2.noncomp(tobias.fp.gr = rV2.groups.tobias.h12.gr.dr, gr.filter = vsx2.feat17, TF.motifs = TF.motifs.out, dataset=dataset, parallel = T)
