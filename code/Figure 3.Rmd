...
```{r Dotplots of Tal1}
Tal1.f6 <- plotFootprintDotplot.rV2(tobias.fp.gr = rV2.groups.tobias.h12.gr.dr, gr.filter = tal1.feat6, TF.motifs = TF.motifs.out, dataset=dataset, parallel=TRUE)

pdf(file=paste(plot_loc,"Tal1_f6_dotplot.pdf",sep=""), width = 8, height = 16)
Tal1.f6
dev.off()

Tal1.f11 <- plotFootprintDotplot.rV2(tobias.fp.gr = rV2.groups.tobias.h12.gr.dr, gr.filter = tal1.feat11, TF.motifs = TF.motifs.out, dataset=dataset, parallel=T)

pdf(file=paste(plot_loc,"Tal1_f11_dotplot.pdf",sep=""), width = 8, height = 16)
Tal1.f11
dev.off()

Tal1.f14 <- plotFootprintDotplot.rV2(tobias.fp.gr = rV2.groups.tobias.h12.gr.dr, gr.filter = tal1.feat14, TF.motifs = TF.motifs.out, dataset=dataset, parallel = T)

pdf(file=paste(plot_loc,"Tal1_f14_dotplot.pdf",sep=""), width = 8, height = 16)
Tal1.f14
dev.off()
```
