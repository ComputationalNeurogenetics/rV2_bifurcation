...
```{r Dotplot expression up and down shapes, fig.height=15, fig.width=6}

data.2.plot <- filter(GA_GL.tal1f6, (fp.log2fc > 1 | fp.log2fc < -1) & (TF.exp.log2fc > 0.5 | TF.exp.log2fc < -0.5) & !(expression.class=="Uncorrelated"))
...
ggplot() + 
geom_point(aes(x = group, y=motif, size=abs(fp.log2fc), fill=TF.exp.log2fc, shape=direction,group=direction),filter(data.2.plot,group=="CO")) + scale_shape_manual(values=c(24,25)) +
geom_point(aes(x = group, y=motif, size=abs(fp.log2fc), fill=TF.exp.log2fc, shape=direction,group=direction),filter(data.2.plot,group=="GA")) + scale_shape_manual(values=c(24,25)) +
geom_point(aes(x = group, y=motif, size=abs(fp.log2fc), fill=TF.exp.log2fc, shape=direction,group=direction),filter(data.2.plot,group=="GL")) + scale_shape_manual(values=c(24,25)) +
theme_minimal() + scale_fill_gradient2(low="blue", mid="gray",high="red", midpoint=0) + theme(axis.text.y = element_text(colour = expression.class.color))

```

```{r Dotplot expression up and down, fig.height=15, fig.width=6}
ggplot() + 
geom_point(aes(x = group, y=motif, size=fp.log2fc, colour=TF.exp.log2fc, shape=expression.class),filter(GA_GL.tal1f6, fp.log2fc > .5 & group=="CO" & (TF.exp.log2fc > 0.5 | TF.exp.log2fc < -0.5) & !(expression.class=="Uncorrelated"))) +
theme_minimal() + 
geom_point(aes(x = group, y=motif, size=fp.log2fc, colour=TF.exp.log2fc, shape=expression.class),filter(GA_GL.tal1f6, fp.log2fc > .5 & group=="GA" & (TF.exp.log2fc > 0.5 | TF.exp.log2fc < -0.5) & !(expression.class=="Uncorrelated"))) +
theme_minimal() + scale_colour_gradient2(low = "blue", mid="grey",high = "red") +
geom_point(aes(x = group, y=motif, size=fp.log2fc, colour=TF.exp.log2fc, shape=expression.class),filter(GA_GL.tal1f6, fp.log2fc > .5  & group=="GL" & (TF.exp.log2fc > 0.5 | TF.exp.log2fc < -0.5) & !(expression.class=="Uncorrelated"))) +
theme_minimal()
```


```{r Dotplot expression up and down 2, fig.height=15, fig.width=6}
ggplot() + 
geom_point(aes(x = group, y=motif, size=fp.log2fc, colour=TF.exp.log2fc, shape=expression.class),filter(GA_GL.tal1f6, fp.log2fc < -.5 & group=="CO" & (TF.exp.log2fc > 0.5 | TF.exp.log2fc < -0.5) & !(expression.class=="Uncorrelated"))) +
theme_minimal() + 
geom_point(aes(x = group, y=motif, size=fp.log2fc, colour=TF.exp.log2fc, shape=expression.class),filter(GA_GL.tal1f6, fp.log2fc < -.5 & group=="GA" & (TF.exp.log2fc > 0.5 | TF.exp.log2fc < -0.5) & !(expression.class=="Uncorrelated"))) +
...
```{r Dotplot version of the above with diminishing expression included, fig.height=20, fig.width=6}
ggplot() + 
geom_point(aes(x = group, y=motif, size=fp.log2fc, colour=TF.exp.log2fc, shape=expression.class),filter(GA_GL.tal1f6, fp.log2fc > 1 & !is.na(TF.exp.log2fc) & !(expression.class=="Uncorrelated"))) +
