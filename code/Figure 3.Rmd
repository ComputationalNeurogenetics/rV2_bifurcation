...
igv<-igvR()
for (i in 1:nrow(Tal1.features)){
  p <- plotHorizDotplot_v3(feature.coords = as.character(Tal1.features[i,2]), igv=igv, cons.filt=cons.gr, max.acc=maxes$max.acc, max.exp = maxes$max.exp, max.fp=maxes$max.fp)
  if(is.list(p)){
...
igv<-igvR()
for (i in 1:nrow(Vsx2.features)){
  p <- plotHorizDotplot_v3(feature.coords = as.character(Vsx2.features[i,2]), igv=igv, cons.filt=cons.gr,max.acc=maxes$max.acc, max.exp = maxes$max.exp, max.fp=maxes$max.fp)
  if(is.list(p)){
...
igv<-igvR()
for (i in 1:nrow(Gata2.features)){
  p <- plotHorizDotplot_v3(feature.coords = as.character(Gata2.features[i,2]), igv=igv, cons.filt=cons.gr,max.acc=maxes$max.acc, max.exp = maxes$max.exp, max.fp=maxes$max.fp)
  if(is.list(p)){
...
igv<-igvR()
for (i in 1:nrow(Gata3.features)){
  p <- plotHorizDotplot_v3(feature.coords = as.character(Gata3.features[i,2]), igv=igv, cons.filt=cons.gr,max.acc=maxes$max.acc, max.exp = maxes$max.exp, max.fp=maxes$max.fp)
  if(is.list(p)){
