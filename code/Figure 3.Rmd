...
igv<-igvR()
for (i in 1:nrow(Tal1.features)){
  p <- plotHorizDotplot_v3(feature.coords = as.character(Tal1.features[i,2]), igv=igv, cons.filt=cons.gr)
  if(is.list(p)){
  pdf(file=paste(plot_loc_tal1,paste("Tal1f",i,"_dotplot_v3.pdf",sep=""),sep=""), width = 15, height = 8)
...
igv<-igvR()
for (i in 1:nrow(Vsx2.features)){
  p <- plotHorizDotplot_v3(feature.coords = as.character(Vsx2.features[i,2]), igv=igv, cons.filt=cons.gr)
  if(is.list(p)){
  pdf(file=paste(plot_loc_vsx2,paste("Vsx2f",i,"_dotplot_v3.pdf",sep=""),sep=""), width = 15, height = 8)
    plot.to.plot <- p$p3 + plot_spacer() + p$p1 + p$p2 + plot_layout(ncol=2,nrow = 2,byrow = TRUE, widths = c(10,.5), heights = c(3,1))
  print(plot.to.plot)
  dev.off()
  }
...
igv<-igvR()
for (i in 1:nrow(Gata2.features)){
  p <- plotHorizDotplot_v3(feature.coords = as.character(Gata2.features[i,2]), igv=igv, cons.filt=cons.gr)
  if(is.list(p)){
  pdf(file=paste(plot_loc_gata2,paste("Gata2f",i,"_dotplot_v3.pdf",sep=""),sep=""), width = 15, height = 8)
    plot.to.plot <- p$p3 + plot_spacer() + p$p1 + p$p2 + plot_layout(ncol=2,nrow = 2,byrow = TRUE, widths = c(10,.5), heights = c(3,1))
  print(plot.to.plot)
  dev.off()
  }
...
igv<-igvR()
for (i in 1:nrow(Gata3.features)){
  p <- plotHorizDotplot_v3(feature.coords = as.character(Gata3.features[i,2]), igv=igv, cons.filt=cons.gr)
  if(is.list(p)){
  pdf(file=paste(plot_loc_gata3,paste("Gata3f",i,"_dotplot_v3.pdf",sep=""),sep=""), width = 15, height = 8)
    plot.to.plot <- p$p3 + plot_spacer() + p$p1 + p$p2 + plot_layout(ncol=2,nrow = 2,byrow = TRUE, widths = c(10,.5), heights = c(3,1))
  print(plot.to.plot)
  dev.off()
  }
