...
Tal1.f6 <- plotFootprintDotplot.rV2.noncomp(tobias.fp.gr = rV2.groups.tobias.h12.gr.dr, gr.filter = tal1.feat6, TF.motifs = TF.motifs.out, dataset=dataset, parallel=TRUE, mc.cores=9)
