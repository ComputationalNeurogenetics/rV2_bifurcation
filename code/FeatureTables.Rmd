...
result.Gata2 <- dbGetQuery(con, query)
...
#result.Gata3 <- left_join(result.Gata3, select(Gata3.features, Feature, Gene_identity, Comment, Ref), by=c("feature"="Feature"))
...
# Execute the query and fetch results
result.Tal1 <- dbGetQuery(con, query)
...
# Execute the query and fetch results
result.Vsx2 <- dbGetQuery(con, query)
