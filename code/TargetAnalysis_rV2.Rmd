...
# Function to plot the barplot of linkage_kbp grouped into categories with reordered x-axis
plot_linkage_kbp_bar <- function(data) {
  # Create categories based on linkage_kbp ranges and remove NA values
  linkage_summary <- data %>%
    filter(!is.na(linkage_kbp)) %>%  # Remove NA values
